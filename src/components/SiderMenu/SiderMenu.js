...
export default class SiderMenu extends PureComponent {
  ...
  */
  getMenuItemPath = (item) => {
    ...
    if (itemPath === '/logout') {
      return (
        <p onClick={() => {this.props.dispatch({type: 'login/logout'})}}>
          {icon}<span>{name}</span>
        </p>
      );
    }
  ...
  */
  ...
  render() {
    ...
    return (
      ...
      >
        <div className={styles.header} key="logo">
          {/* <Link to="/">
          ...
          {/* <div>
            ...
            <div>
              <p className={styles.login}>李四</p>
              <h3 className={styles.title}>电梯物联 Lv.10</h3>
