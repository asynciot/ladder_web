export const menuB=[{
	...
	children:[
		...
		{num:1,label:'Opening arrival keeping torque',value:'',visible: true,
			explain:"parameter(Opening arrival keeping torque)"},
		{num:1,label:'Close arrival keeping torque',value:'',visible: true,
			explain:"parameter(Close arrival keeping torque)"},
		{num:1,label:'Opening loop torque maximum voltage',value:'',visible: true,
			explain:"parameter(Opening loop torque maximum voltage)"},
		{num:1,label:'Closing loop torque maximum voltage',value:'',visible: true,
			explain:"parameter(Closing loop torque maximum voltage)"},
		{num:1,label:'Closing speed-down loop torque maximum voltage',value:'',visible: true,
			explain:"parameter(Closing speed-down loop torque maximum voltage)"},
		{num:1,label:'DC brake voltage',value:'',visible: true,
			explain:"parameter(DC brake voltage)"},
		{num:1,label:'Maximum Torque',value:'',visible: true,
			explain:"parameter(Maximum Torque)"},
		{num:100,label:'Overload protection current',value:'',visible: true,
			explain:"parameter(Overload protection current)"},
		{num:100,label:'Closing overload current speed up &donw',value:'',visible: true,
			explain:"parameter(Closing overload current speed up &donw)"},
		{num:100,label:'Closing Overload Current during Stable Operation',value:'',visible: true,
		...
		{num:1,label:'Closing overload anti-open enable setting',value:'',visible: true,
			explain:"parameter(Closing overload anti-open enable setting)"},
		{num:1,label:'Opening arrival relay Polar setting',value:'',visible: true,
			explain:"parameter(Opening arrival relay Polar setting)"},
		{num:1,label:'Closing arrival relay Polar setting',value:'',visible: true,
			explain:"parameter(Closing arrival relay Polar setting)"},
		{num:1,label:'Multi-function reply Y polar setting',value:'',visible: true,
			explain:"parameter(Multi-function reply Y polar setting)"},
		{num:1,label:'Opening arrival input switch polar setting',value:'',visible: true,
			explain:"parameter(Opening arrival input switch polar setting)"},
		{num:1,label:'Closing arrival input switch polar setting',value:'',visible: true,
			explain:"parameter(Closing arrival input switch polar setting)"},
		{num:1,label:'Opening speed down input switch polar setting',value:'',visible: true,
			explain:"parameter(Opening speed down input switch polar setting)"},
		{num:1,label:'Closing speed down input switch polar setting',value:'',visible: true,
			explain:"parameter(Closing speed down input switch polar setting)"},
		{num:1,label:'Relay Y function setting',value:'',visible: true,
			explain:"parameter(Relay Y function setting)"},
		{num:1,label:'Door operator testing slef-running',value:'',visible: true,
			explain:"parameter(Door operator testing slef-running)"},
		{num:1,label:'Retined',value:'',visible: true,
			explain:"parameter(Retined)"},
		{num:1,label:'Motor no-load current',value:'',visible: true,
			explain:"parameter(Motor no-load current)"},
		{num:1,label:'Data initialization',value:'',visible: true,
			explain:"parameter(Data initialization)"},
		{num:1,label:'Closing terminal torque lifting',value:'',visible: true,
			explain:"parameter(Closing terminal torque lifting)"},
		{num:1,label:'Control mode mark',value:'',visible: true,
			explain:"parameter(Control mode mark)"},
		{num:1,label:'Closing deceleration Position',value:'',visible: true,
			explain:"parameter(Closing deceleration Position)"},
		{num:1,label:'Opening deceleration Position',value:'',visible: true,
			explain:"parameter(Opening deceleration Position)"},
		{num:1,label:'Door Width Distance',value:'',visible: true,
